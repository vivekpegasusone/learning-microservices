...
import static com.whizzy.rentcloud.authservice.util.OAuth2Util.*;

public class OAuth2AuthorizationToEntityMapper {
    private final ObjectMapper objectMapper = new ObjectMapper();

    public OAuth2AuthorizationToEntityMapper() {
        ClassLoader classLoader = OAuth2AuthorizationToEntityMapper.class.getClassLoader();
        List<Module> securityModules = SecurityJackson2Modules.getModules(classLoader);
        this.objectMapper.registerModules(securityModules);
        this.objectMapper.registerModule(new OAuth2AuthorizationServerJackson2Module());
    }

    public OAuth2Authorization toOAuth2Authorization(Authorization entity, RegisteredClient registeredClient) {
        ...
        if (entity.getAuthorizationCodeValue() != null) {
            ...
            builder.token(authorizationCode, metadata -> metadata.putAll(parseMap(this.objectMapper, entity.getAuthorizationCodeMetadata())));
        }
        ...
        if (entity.getAccessTokenValue() != null) {
            ...
            builder.token(accessToken, metadata -> metadata.putAll(parseMap(this.objectMapper, entity.getAccessTokenMetadata())));
        }
        ...
        if (entity.getRefreshTokenValue() != null) {
            ...
            builder.token(refreshToken, metadata -> metadata.putAll(parseMap(this.objectMapper, entity.getRefreshTokenMetadata())));
        }
        ...
        if (entity.getOidcIdTokenValue() != null) {
            ...
            builder.token(idToken, metadata -> metadata.putAll(parseMap(this.objectMapper, entity.getOidcIdTokenMetadata())));
        }
        ...
        if (entity.getUserCodeValue() != null) {
            ...
            builder.token(userCode, metadata -> metadata.putAll(parseMap(this.objectMapper, entity.getUserCodeMetadata())));
        }
        ...
        if (entity.getDeviceCodeValue() != null) {
            ...
            builder.token(deviceCode, metadata -> metadata.putAll(parseMap(this.objectMapper, entity.getDeviceCodeMetadata())));
        }
